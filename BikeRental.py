...
class BikeRental:
    ...
    def rent_bike_on_hourly_bases(self, num_bikes):
        ...
        if 0 >= num_bikes or num_bikes > self.__stock:
            print(f"You need to enter valid number. We currently have {self.__stock} available.")
            return None
        else:
    ...
    # TODO 6 - Create a method to return bike from the customer
